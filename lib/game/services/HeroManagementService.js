...
const RARITY_WEIGHTS = { F: 0.30, E: 0.30, D: 0.25, C: 0.10, B: 0.04, A: 0.01, S: 0.00 };
...
const _HERO_NAMES = [
  'Rusty', 'Blaze', 'Storm', 'Shadow', 'Finn', 'Atlas', 'Sage', 'Fox', 'Bear', 'Wolf',
  'Luna', 'Nova', 'Ruby', 'Jade', 'Ivy', 'Pearl', 'Rose', 'Lily', 'Willow', 'Iris',
  'Max', 'Ace', 'Rex', 'Jay', 'Kai', 'Leo', 'Sam', 'Ben', 'Dan', 'Ray',
  'Zoe', 'Mia', 'Ava', 'Emma', 'Ella', 'Ana', 'Grace', 'Claire',
  'Ghost', 'Hawk', 'Bolt', 'Ember', 'Frost', 'Thunder', 'Crystal', 'Titan', 'Phoenix', 'Dragon',
];
